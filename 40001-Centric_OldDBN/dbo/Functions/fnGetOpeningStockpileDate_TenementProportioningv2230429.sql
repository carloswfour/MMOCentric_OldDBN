...
CREATE FUNCTION [dbo].[fnGetOpeningStockpileDate_TenementProportioningv2230429] (@stockpileName VARCHAR(100),@cutoffDate DATETIME)
RETURNS DATETIME
AS
BEGIN
	...
	--	END AS SHIFT_DATE
	--	FROM BUSINESS_UNIT_JOURNAL AS BUJ
	--	INNER JOIN BUSINESS_UNIT AS BU
