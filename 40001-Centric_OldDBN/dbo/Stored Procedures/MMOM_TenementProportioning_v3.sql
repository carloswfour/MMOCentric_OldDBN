--exec MMOM_TenementProportioning_v3 
CREATE procedure [dbo].[MMOM_TenementProportioning_v3] as
--230428
-- categorise by material type
-- 230416
...
null as --expit.
expit_DT,
--stockpiled.stockpiled_DT/stockpiled_DT_total*rehandled.rehandle_WT 
null AS rehandled_WT,
--stockpiled.stockpiled_DT/stockpiled_DT_total*rehandled.rehandle_DT 
null AS rehandled_DT
into MMOM_TenementProportioning_v2_Materialised_230429_01
FROM (
	SELECT
	stockpiled.stockpile,
	stockpiled.tenement,
